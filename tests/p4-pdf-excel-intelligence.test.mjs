...
import {
  ...
  attachAutoDetections, buildP4ExcelPlan, assertP4CalculationBarrier, classifyP4Trust
...
test('P4 Excel plan contains Vietnamese provenance/review sheets and no internal promotion',()=>{
...
import { p4PacketFromSelectionSource, p4PacketFromImageReview } from '../src/p4-pdf-excel-ui.js';
