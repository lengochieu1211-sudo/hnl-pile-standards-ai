...
// Never lower any certified component and never skip tests. Final expected suite = 605/605/0.
const BASELINE_TESTS = 574;
const P4_ADDITIVE_TESTS = 18;
const SPT_GOLDEN_ADDITIVE_TESTS = 13;
const EXPECTED_TESTS = BASELINE_TESTS + P4_ADDITIVE_TESTS + SPT_GOLDEN_ADDITIVE_TESTS;
...
console.log(`PASS83 TEST COUNT GATE: PASS ${EXPECTED_TESTS}/${EXPECTED_TESTS}, fail 0 · baseline ${BASELINE_TESTS} + P4 ${P4_ADDITIVE_TESTS} + SPT Golden ${SPT_GOLDEN_ADDITIVE_TESTS}`);
