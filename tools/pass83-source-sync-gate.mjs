...
// HNL P1 Pass 8.3 source synchronization gate refreshed through P5.3 static-load promotion.
...
const expected = {
  ...
  'src/engineering-router.js':'fcde1ce8870f3a5922a36ca1c040e2330b482839e794374bc905810bcdc22ecf',
...
console.log('PASS83 SOURCE SYNC GATE: PASS (P5.3 static-load-certified integration source synchronized; Search/PDF/AI preserved)');
