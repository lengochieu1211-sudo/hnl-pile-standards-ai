...
// HNL P1 Pass 8.3 source synchronization gate refreshed through P5.8 piled-raft method gate.
...
const expected = {
  ...
  'src/engineering-router.js':'8c66b62b3a14260d770e53619f47168abee3a84ab76de194eb7451ee6c90532a',
...
console.log('PASS83 SOURCE SYNC GATE: PASS (P5.8 piled-raft-certified integration source synchronized; Search/PDF/AI preserved)');
