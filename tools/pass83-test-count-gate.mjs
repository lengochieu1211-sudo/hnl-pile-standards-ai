...
// P5.4 dynamic/PDA promotion adds 6 additive CT22-24/boundary/provenance/PDA-isolation tests.
// P5.5 settlement promotion adds 9 additive CT30-46/Table17/applicability/export tests.
...
// Never lower any certified component and never skip tests. Final expected suite = 654/654/0.
...
const DYNAMIC_P5_ADDITIVE_TESTS = 6;
const SETTLEMENT_P5_ADDITIVE_TESTS = 9;
const SCREW_P5_ADDITIVE_TESTS = 10;
const PILED_RAFT_P5_ADDITIVE_TESTS = 10;
const EXPECTED_TESTS = BASELINE_TESTS + P4_ADDITIVE_TESTS + SPT_GOLDEN_ADDITIVE_TESTS + CPT_P5_ADDITIVE_TESTS + STATIC_P5_ADDITIVE_TESTS + DYNAMIC_P5_ADDITIVE_TESTS + SETTLEMENT_P5_ADDITIVE_TESTS + SCREW_P5_ADDITIVE_TESTS + PILED_RAFT_P5_ADDITIVE_TESTS;
...
console.log(`PASS83 TEST COUNT GATE: PASS ${EXPECTED_TESTS}/${EXPECTED_TESTS}, fail 0 · baseline ${BASELINE_TESTS} + P4 ${P4_ADDITIVE_TESTS} + SPT Golden ${SPT_GOLDEN_ADDITIVE_TESTS} + CPT P5 ${CPT_P5_ADDITIVE_TESTS} + Static P5 ${STATIC_P5_ADDITIVE_TESTS} + Dynamic P5 ${DYNAMIC_P5_ADDITIVE_TESTS} + Settlement P5 ${SETTLEMENT_P5_ADDITIVE_TESTS} + Screw P5 ${SCREW_P5_ADDITIVE_TESTS} + Piled Raft P5 ${PILED_RAFT_P5_ADDITIVE_TESTS}`);
