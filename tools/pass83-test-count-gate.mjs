...
console.log(`PASS83 TEST COUNT GATE: PASS ${EXPECTED_TESTS}/${EXPECTED_TESTS}, fail 0 · baseline ${BASELINE_TESTS} + P4 ${P4_ADDITIVE_TESTS} + SPT Golden ${SPT_GOLDEN_ADDITIVE_TESTS} + CPT P5 ${CPT_P5_ADDITIVE_TESTS} + Static P5 ${STATIC_P5_ADDITIVE_TESTS}`);
