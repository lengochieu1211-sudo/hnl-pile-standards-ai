...
// HNL P1 Pass 8.3 source synchronization gate refreshed through P5.6 screw-pile promotion.
...
const expected = {
  ...
  'src/engineering-router.js':'b3f39077ed5d716cfe7600882646d1ac9b1d219da665f0908440ab59be192883',
...
console.log('PASS83 SOURCE SYNC GATE: PASS (P5.6 screw-pile-certified integration source synchronized; Search/PDF/AI preserved)');
