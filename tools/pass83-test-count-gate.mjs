...
// Never lower any certified component and never skip tests. Final expected suite = 625/625/0.
...
const EXPECTED_TESTS = BASELINE_TESTS + P4_ADDITIVE_TESTS + SPT_GOLDEN_ADDITIVE_TESTS + CPT_P5_ADDITIVE_TESTS + STATIC_P5_ADDITIVE_TESTS + DYNAMIC_P5_ADDITIVE_TESTS;
...
console.log(`PASS83 TEST COUNT GATE: PASS ${EXPECTED_TESTS}/${EXPECTED_TESTS}, fail 0 · baseline ${BASELINE_TESTS} + P4 ${P4_ADDITIVE_TESTS} + SPT Golden ${SPT_GOLDEN_ADDITIVE_TESTS} + CPT P5 ${CPT_P5_ADDITIVE_TESTS} + Static P5 ${STATIC_P5_ADDITIVE_TESTS} + Dynamic P5 ${DYNAMIC_P5_ADDITIVE_TESTS}`);
