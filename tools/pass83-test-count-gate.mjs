...
// HNL v1.27 research certification.
// Locked production baseline = 574 tests. P4 adds exactly 18 additive shadow tests.
// Never lower the baseline and never skip tests. Final expected suite = 592/592/0.
const BASELINE_TESTS = 574;
const P4_ADDITIVE_TESTS = 18;
const EXPECTED_TESTS = BASELINE_TESTS + P4_ADDITIVE_TESTS;
...
console.log(`PASS83 TEST COUNT GATE: PASS ${EXPECTED_TESTS}/${EXPECTED_TESTS}, fail 0 · baseline ${BASELINE_TESTS} + P4 ${P4_ADDITIVE_TESTS}`);
